...
# *****************************************************************************
#
# File:        application-insights-template-cli.sh
#
# Description: Creates an Application Insights Component backed by a Log
#              Analytics Workspace, from an ARM template.
#
...
az deployment group create \
  ...
  --template-file "application-insights.azuredeploy.json" \
  --parameters @"application-insights.azuredeploy.parameters.json" \
