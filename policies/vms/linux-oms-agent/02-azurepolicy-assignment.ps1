...
#
# Description: Assigns a policy to deny installation of the Linux OMS agent.
#
...
$policyName = "deny-linux-oms-agent"
...
New-AzPolicyAssignment -Name "deny-linux-oms-agent" `
