...
namespace RecognizeTextConsole
{
    class Program
    {
        ...
        //private const string localImagePath = @"..\..\..\..\800px-Cursive_Writing_on_Notebook_paper.jpg";
        //private const string localImagePath = @"..\..\..\..\best handwriting font22.jpg";
        private const string localImagePath = @"..\..\..\..\ocr2.jpg";
